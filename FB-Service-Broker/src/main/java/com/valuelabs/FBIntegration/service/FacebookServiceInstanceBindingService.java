...
@Service
public class FacebookServiceInstanceBindingService implements ServiceInstanceBindingService {

	Logger log = LoggerFactory.getLogger("FacebookServiceInstanceBindingService");
